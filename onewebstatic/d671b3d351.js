...
oneJQuery(function ($) {
    ...
    json.afterAction = function () {
        ...
        oneJQuery('#slidesjs-BA139A9E-F470-4261-B4D7-76616DE36D16 .slider-caption').each(function () {
            var el = oneJQuery(this);
            el.width(el.parent().width() - 10);
        });
        oneJQuery('#slidesjs-BA139A9E-F470-4261-B4D7-76616DE36D16 .slide-cntnr.middle p.slider-caption').each(function () {
            var el = oneJQuery(this);
            el.height(el.find('span').height());
        });
    };
    var $slidejs = $('#slidesjs-BA139A9E-F470-4261-B4D7-76616DE36D16');
    if ($slidejs.children().length) {
        var carousel = $slidejs.owlCarousel(json);
        carousel.data('owlCarousel').updateVars();
        var resetHeight = function () {
            if (window.innerWidth < 650) {
                var ratio = 0.6635338345864662;
                if ($('#slidesjs-BA139A9E-F470-4261-B4D7-76616DE36D16').parents('.textblock').length) {
                    ratio = ratio / 2;
                }
                $('#slidesjs-BA139A9E-F470-4261-B4D7-76616DE36D16').height((window.innerWidth - 40) * ratio);
                $('#slidesjs-BA139A9E-F470-4261-B4D7-76616DE36D16 .slider-item').height((window.innerWidth - 40) * ratio);
                $('#slidesjs-BA139A9E-F470-4261-B4D7-76616DE36D16 .slider-caption').parent().height((window.innerWidth - 40) * ratio);
            }
        };
